...
/*   Updated: 2023/07/09 16:20:57 by isouaidi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	img(t_map *map)
{
	map->img_ptr_p = get_img(map, "./xpm/perso/persoface1.xpm");
	...
	map->img_ptr_mo = get_img(map, "./xpm/r1.xpm");
	map->img_ptr_pg = get_img(map, "./xpm/perso/persoG.xpm");
	map->img_ptr_pd = get_img(map, "./xpm/perso/persoD.xpm");
	map->img_ptr_pa = get_img(map, "./xpm/perso/persoface1.xpm");
	map->img_ptr_pdo = get_img(map, "./xpm/perso/persoDo1.xpm");
}
