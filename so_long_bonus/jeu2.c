...
/*   Updated: 2023/07/09 16:23:44 by isouaidi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	key0(int key, t_map *map)
{
	...
	{
		map->p = 1;
		if ((map->cpymap[map->pj][map->pi - 1] != '1') &&
		(map->cpymap[map->pj][map->pi - 1] == 'M'))
			fin(1);
		if (map->c == 0)
		{
...
void	key1(int key, t_map *map)
{
	...
	{
		map->p = 3;
		if ((map->cpymap[map->pj + 1][map->pi] != '1') &&
			(map->cpymap[map->pj + 1][map->pi] == 'M'))
			fin(1);
		if (map->c == 0)
		{
